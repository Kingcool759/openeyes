...
object AppApi {
     ...
     //首页-推荐
     const val home_Tuijianbao_List = "api/v5/index/tab/feed?date=1603414800000&num=2&udid=e3baaab6f0484b5188ccc05cbec33ba51b92f208&vc=6030101&vn=6.3.10&size=1080X2400&deviceModel=TEL-AN00a&first_channel=huawei&last_channel=huawei&system_version_code=29 HTTP/1.1"
     //首页-日报
