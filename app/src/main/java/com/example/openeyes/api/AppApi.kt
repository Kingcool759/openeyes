...
object AppApi {
     ...
     //首页-发现
     const val home_faxian_List = "api/v7/index/tab/discovery?udid=e3baaab6f0484b5188ccc05cbec33ba51b92f208&vc=6030101&vn=6.3.10&size=1080X2400&deviceModel=TEL-AN00a&first_channel=huawei&last_channel=huawei&system_version_code=29"
     //首页-推荐
     const val home_tuijian_List = "v1/card/page/get_page HTTP/1.1"
     //首页-日报
